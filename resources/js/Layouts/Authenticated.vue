            ...
            <nav class="bg-white dark:bg-gray-900 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <VegifyLogo type="icon" class="block h-9 w-auto" />
                                </Link>
                            </div>

                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <BreezeNavLink v-for="(navLink, index) in navLinks" :key="index" class="dark:text-white"
                                    :href="route(navLink.route)" :active="
                                        route()
                                            .current()
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <BreezeResponsiveNavLink v-for="(navLink, index) in navLinks" :key="index"
                            :href="route(navLink.route)" :active="
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <BreezeResponsiveNavLink class="dark:text-white" :href="route('logout')" method="post"
                                as="button">
                                Log Out
                            </BreezeResponsiveNavLink>
                        </div>
