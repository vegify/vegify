...
const Icon = computed(() => preferredColorScheme.value == 'dark' ? VegifyIconOrigBGDark : VegifyIconOrigBGLight);
</script>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">
                                <BreezeNavLink class="dark:text-white" :href="route('dashboard')"
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <BreezeResponsiveNavLink class="dark:text-white" :href="route('logout')" method="post" as="button">
                                Log Out
                            </BreezeResponsiveNavLink>
                        </div>
                    </div>
