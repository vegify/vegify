        ...
        <template v-slot:sidebar>
            <div v-if="canLogin" class="w-full">
                <div v-if="$page.props.auth.user">
                    <header
                        class="font-bold text-right text-2xl px-4 dark:text-gray-light"
                    >
                ...
                <template v-else>
                    ...
                    >
                        <span class="text-right"
                            >Start tracking recipes with us, today.</span
                        >
                    ...
                    <VegifyLogo
                        type="icon"
                        color="greenwhite"
                        class="h-20 mx-auto my-4 w-auto"
                    />

                    <div
                        class="mx-auto my-4 pt-8 text-center w-full"
                        scroll-region
                    >
                        <input
                            type="radio"
