...
<template>
    <div
        ...
        <div class="p-2 w-full bg-white dark:bg-gray-dark">
            <div class="font-bold text-3xl dark:text-white"> {{ recipe.as_ingredient.name }} </div>
            <div class="font capitalize font-serif text-sm leading-6"> {{ recipe.subtitle }} </div>
            <div class="font-[300] text-2xl tracking-widest">000</div>
            <div class="font-light font-serif tracking-wide text-xs"> Calories Per Serving </div>
        </div>
    </div>
</template>
