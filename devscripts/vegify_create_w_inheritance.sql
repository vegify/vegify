...
-- Reference: ingredient_in_recipe_nutrient_amount_nutrient (table: ingredient_in_recipe_nutrient_amount)
ALTER TABLE ingredient_in_recipe_nutrient_amount ADD CONSTRAINT ingredient_in_recipe_nutrient_amount_nutrient
    FOREIGN KEY (nutrient_id)
    REFERENCES nutrient (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: ingredient_serving_nutrient_amount_nutrient (table: ingredient_serving_nutrient_amount)
ALTER TABLE ingredient_serving_nutrient_amount ADD CONSTRAINT ingredient_serving_nutrient_amount_nutrient
    FOREIGN KEY (nutrient_id)
    REFERENCES nutrient (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: nutrition_profile_tracked_nutrient_nutrient (table: nutrition_profile_tracked_nutrient)
ALTER TABLE nutrition_profile_tracked_nutrient ADD CONSTRAINT nutrition_profile_tracked_nutrient_nutrient
    FOREIGN KEY (nutrient_id)
    REFERENCES nutrient (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
